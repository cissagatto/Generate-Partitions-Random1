...
##################################################################################################
executeGPR1 <- function(number_dataset, number_cores, number_folds, folderResults){
  ...
  timeGPR1 = system.time(resGPR1 <- generateR1(namesLabels, number_folds, dataset_name, ds, folderResults))
  cat("\n##################################################################################################\n\n") 
