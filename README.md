...
<img src="https://github.com/cissagatto/Generate-Partitions-Random1/blob/main/images/tipos_particoes_aleatorias_transparente.png" width="300">
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random1/blob/main/images/10-Folds-Cross-Validation.png" width="300">

### Step-2
Place a copy of this code in _"C:/Users/[username]/Generate-Partitions-Random1"_ or _"/home/username/Generate-Partitions-Random1_. Our files are configured to obtain the paths of the folders from the root. You can change this in the code if you want.
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random1/blob/main/images/Folder-Structure-R1.png" width="300">
...
<img src="https://github.com/cissagatto/Generate-Partitions-Random1/blob/main/images/OutPut-R1.png" width="300">

## RUN
To run the code, open the terminal, enter */home/[username]/Generate-Partitions-Random1/scripts/* folder, and type:

```
Rscript random1.R [number_dataset] [number_cores] [number_folds] [name_folder_results]
```
...
```
Rscript random1.R 17 5 10 "/dev/shm/results/"
```
